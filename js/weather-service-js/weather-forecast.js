...
// Taluka Vector
 ...
 const weatherLayersVector = new ol.layer.Group({
  ...
  // Loader for display
  // Start loader
  talukaVectorLayer.getSource().on("featuresloadstart", function (evt) {
    document.getElementById("layer-loader").classList.add("loader");
  });
  // Stop loader
  talukaVectorLayer.getSource().on("featuresloadend", function (evt) {
...
$("#forecat-info-div").hide();
// Close icon logic
$('.close-icon').on('click',function() {
  var $target = $('#forecat-info-div')
  $target.hide('slow', function(){ $target.hide(); });
});
          ...
          <tr class="td-icon">
            ...
            <td>
              <img
                ...
                srcset="
                  ../../assets/weather_icon/windy_1.png 2x
                "
              />
            </td>
            <td>
              <img
                ...
                srcset="
                  ../../assets/weather_icon/windy_2.png 2x
                "
              />
            </td>
            <td>
              <img
                ...
                srcset="
                  ../../assets/weather_icon/windy_3.png 2x
                "
              />
            </td>
            <td>
